...
<div class="admin-container">
    ...
    <div class="admin-card">
        <form method="POST" action="{{ route('admin.resources.update', $resource) }}" class="resource-form">
            @csrf
            @method('PUT')
            ...
            <div class="form-grid">
                ...
                <div class="form-group">
                    ...
                    <input 
                        ...
                        name="bandwidth" 
                        class="form-input" 
                        value="{{ old('bandwidth', $resource->bandwidth) }}"
                ...
                <div class="form-group full-width">
                    ...
                    <select id="status" name="status" class="form-input" required>
                        <option value="active" {{ old('status', $resource->status) == 'active' ? 'selected' : '' }}>Actif</option>
                        <option value="inactive" {{ old('status', $resource->status) == 'inactive' ? 'selected' : '' }}>Inactif</option>
